...
* ¿Cómo gestionas actualmente los pedidos de tus clientes?
* ¿Qué herramientas utilizas para organizar tu trabajo?
* ¿Cómo te comunican los pedidos los (supermercados/minimarkets/cadenas de restaurantes, etc.)?
* ¿Cómo verificas la calidad de la fruta antes de entregarla?
* ¿Qué problemas enfrentas al trabajar con (supermercados/minimarkets/cadenas de restaurantes, etc.)?
* ¿Cómo gestionas a tus proveedores?
* ¿Has tenido rechazos de productos? ¿Por qué?
* ¿Cómo organizas la información de pedidos, fechas y entregas?
* ¿Cuánto tiempo te toma preparar un pedido?
* ¿Qué haces cuando no tienes stock suficiente?
* ¿Qué tan seguido recibes auditorías?
* ¿Qué información consideras más importante registrar?
* ¿Usas celular o computadora para trabajar?

**Productores:**
* ¿Cómo vendes tus productos actualmente?
* ¿Trabajas con distribuidores o directamente con clientes?
* ¿Cómo aseguras la calidad de tus productos?
* ¿Qué criterios usas para clasificar la fruta (calibre, estado)?
* ¿Cómo recibes pedidos de los distribuidores?
* ¿Qué problemas tienes al cumplir pedidos?
* ¿Cómo manejas la disponibilidad de productos?
* ¿Con cuántos distribuidores trabajas?
* ¿Qué haces cuando hay sobreproducción o escasez?
* ¿Te devuelven productos? ¿Por qué?
* ¿Cómo te comunicas con tus clientes?

**Clientes Comerciales:**
* ¿Cómo gestionan actualmente la compra de frutas?
* ¿Qué factores consideran al elegir un proveedor?
* ¿Qué requisitos debe cumplir un proveedor?
* ¿Cómo realizan sus pedidos? (sistema, llamada, WhatsApp, etc.)
* ¿Qué información esperan recibir junto al producto?
* ¿Cómo verifican la calidad de la fruta?
* ¿En qué casos rechazan un pedido?
* ¿Qué problemas han tenido con proveedores?
* ¿Con cuántos proveedores trabajan?
* ¿Qué tan importante es la puntualidad en la entrega?
...
La entrevista a Renato Navarro, productor de manzanas de 25 años residente en el Cercado de Lima, permitió conocer las dificultades que enfrenta al organizar su producción y atender los pedidos de sus clientes. Su coordinación se realiza principalmente mediante llamadas y mensajes, y los pedidos suelen llegar con poca anticipación, lo que dificulta planificar adecuadamente la cosecha y las entregas. Para gestionar sus actividades se apoya en su experiencia y en anotaciones manuales, situación que puede generar desorden o errores en el registro de información. El control de calidad de las frutas se realiza de manera visual, considerando características como el tamaño, color y estado físico del producto. Asimismo, factores externos como el clima pueden afectar la calidad y disponibilidad de la producción. Renato considera necesario contar con mejores herramientas tecnológicas que le permitan organizar los pedidos, mejorar la comunicación con sus clientes y llevar un mayor control de la calidad de sus productos.

**Resumen – Karen Forcelledo**

La entrevista a Karen Forcelledo, productora agrícola de 37 años residente en San Borja, permitió comprender una operación basada principalmente en la coordinación directa con un número reducido de distribuidores. La comunicación con sus compradores se realiza mediante WhatsApp, redes sociales y trato presencial, sin contar con un sistema formal que centralice la información de pedidos y entregas. El control de calidad se basa en los estándares establecidos para el producto y en la evaluación de su estado físico. Entre las principales dificultades de su actividad se encuentran la estacionalidad, la sobreproducción o escasez y factores externos como los huaicos, que pueden afectar la disponibilidad de los productos y el cumplimiento de las entregas. También ha enfrentado devoluciones vinculadas a la informalidad de algunos compradores. Estas situaciones evidencian la necesidad de mejorar la planificación, el control de información y la coordinación con distribuidores mediante herramientas que permitan organizar de manera más estructurada sus operaciones.

**Resumen – Jessica**

La entrevista a Jessica, comerciante de 52 años residente en San Martín de Porres y con 12 años de experiencia en el rubro de abastos, permitió conocer una operación vinculada al abastecimiento y manejo de productos frescos. Su jornada comienza desde tempranas horas con el traslado al Gran Mercado Mayorista de Santa Anita para adquirir mercadería, priorizando este centro por la disponibilidad, frescura y mejores condiciones de precio de determinados productos. Durante su actividad identifica como dificultades importantes los daños que pueden sufrir los productos durante el transporte y los efectos de factores climáticos, como las lluvias en las zonas de origen, que pueden reducir su calidad y valor comercial. Además, parte de su operación incluye actividades de valor agregado como el pelado, picado y embolsado de productos, por lo que resulta importante mantener un mayor control del inventario y de las mermas físicas generadas durante el proceso. Su experiencia evidencia la necesidad de contar con mejor información sobre disponibilidad, calidad y pérdidas de productos dentro de la cadena de abastecimiento.
...
La entrevista a Jorge Contreras Ballarta, coordinador logístico de 45 años residente en Cieneguilla que abastece a supermercados, permitió entender su proceso de trabajo actual. Él gestiona los pedidos mediante una plataforma B2B, complementando su coordinación a través de su celular y computadora. Los pedidos se reciben con 48 horas de anticipación, aunque esto le sigue generando retos en la planificación de transporte. Para organizar su trabajo, emplea un enfoque mixto: utiliza herramientas digitales para las órdenes de compra y registros manuales de apoyo. Cuando no cuenta con stock suficiente, recurre inmediatamente a proveedores de confianza. El control de calidad se basa en estrictas fichas técnicas formales (peso, precio, apariencia); sin embargo, ha enfrentado rechazos esporádicos por defectos internos no detectados vinculados a la estacionalidad de las frutas. Finalmente, resalta la importancia de las auditorías constantes que garantizan su operatividad con supermercados y reconoce la necesidad de mayor digitalización para mejorar la trazabilidad.

**Resumen – Paola Jiménez**

La entrevista a Paola Jiménez, supervisora de operaciones logísticas de 25 años residente en San Juan de Miraflores, permitió comprender cómo gestiona su distribución diaria. Administra pedidos de forma mixta: recibe los requerimientos de manera informal por llamadas y WhatsApp, anota los encargos en un cuaderno y luego los organiza en su laptop y celular, apoyándose en Excel. El tiempo de preparación varía entre 30 minutos y 4 horas. Al igual que otros distribuidores, cuando enfrenta escasez o variabilidad de stock, se apoya en una red de proveedores de confianza. Su control de calidad es estrictamente visual y manual (evaluando color, estado de la cáscara y madurez), lo que la ha llevado a sufrir rechazos de clientes por productos en mal estado (como mangos demasiado maduros). Enfrenta problemas constantes de planificación debido a los pedidos con muy poca anticipación, priorizando la necesidad de herramientas tecnológicas que centralicen la información y agilicen sus tiempos de respuesta.

**Resumen – Edwin Lozano**

La entrevista a Edwin Lozano, jefe de almacén y distribuidor de 38 años residente en Perené, evidenció los retos operativos y logísticos en la distribución de plátanos y otras frutas. Recibe sus pedidos principalmente por llamadas o mensajes de WhatsApp y gestiona su operación combinando el uso constante de su celular con apuntes manuales en un cuaderno. La preparación depende del volumen solicitado y, para cumplir con las exigencias de sus clientes cuando no tiene disponibilidad, recurre a proveedores de confianza. El control de calidad lo realiza de forma visual, revisando estado, color y nivel de maduración. Pese a su experiencia, ha enfrentado rechazos de mercadería al no detectar a tiempo problemas de calidad. Sus mayores dificultades recaen en la variabilidad del stock, la falta de planificación por pedidos de último minuto y la necesidad de responder rápidamente, destacando una clara apertura hacia el uso de aplicaciones móviles intuitivas que simplifiquen su coordinación diaria.
...
En cuanto a los canales de comunicación, el 100% utiliza medios directos como llamadas, WhatsApp o contacto personal con proveedores por teléfono celular, mientras que solo el 33% complementa este proceso con sistemas formales de órdenes de compra. Esto demuestra una fuerte dependencia de herramientas informales para la gestión de pedidos.
...
En relación con la verificación de calidad, el 100% realiza controles al momento de la recepción del producto, principalmente de forma visual y sensorial (frescura, estado, color, olor); y con los controles realizados hace un registro en sus laptops o computadoras para poder saber exactamente que pedidos recibió bien y cuales mal para poder notificar y tomar una decisión. Esto refleja una alta dependencia del criterio humano para validar la calidad de la fruta.
